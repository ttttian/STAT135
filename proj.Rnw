...
\item
<<Q5.3.1, cache=TRUE, echo=FALSE>>=
glyhb.lm.coeff <- coefficients(glyhb.lm)
@
...
ggplot(data.df) +
  geom_point(aes(x=stab.glu, y=scale(glyhb-glyhb.lm.fit))) +
...
ggplot(data.df) +
  geom_point(aes(x=BMI, y=scale(glyhb-glyhb.lm.fit))) +
  geom_abline(aes(intercept=0, slope=0)) +
  labs(title="Residuals plot of glyhb vs BMI",
       y="standardized residuals") +
  theme(text=element_text(size=8.5))
@

<<Q5.5.3, cache=TRUE, echo=FALSE, fig.align="center", fig.pos="H", fig.width=5, fig.height=3>>=
ggplot(data.df) +
  geom_point(aes(x=WHR, y=scale(glyhb-glyhb.lm.fit))) +
  geom_abline(aes(intercept=0, slope=0)) +
  labs(title="Residuals plot of glyhb vs WHR",
       y="standardized residuals") +
  theme(text=element_text(size=8.5))
@

<<Q5.5.4, cache=TRUE, echo=FALSE, fig.align="center", fig.pos="H", fig.width=5, fig.height=3>>=
ggplot(data.df) +
